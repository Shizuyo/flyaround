...
use WCS\flyReservationBundle\Entity\Flight;
...
class FlightController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $flights = $em->getRepository('WCSflyReservationBundle:Flight')->findAll();
    ...
    {
        $flight = new Flight();
        $form = $this->createForm('WCS\flyReservationBundle\Form\FlightType', $flight);
    ...
    {
        $deleteForm = $this->createDeleteForm($flight);
        $editForm = $this->createForm('WCS\flyReservationBundle\Form\FlightType', $flight);
